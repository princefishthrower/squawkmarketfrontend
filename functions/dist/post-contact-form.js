...
var handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    var htmlContent, body, prop, mailjet, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                htmlContent = ["<h1>Squawk Market Contact Data:</h1>"];
                body = JSON.parse(event.body);
                // loop at body keys
                for (prop in body) {
                    htmlContent.push("<p><b>".concat(prop, ":</b> ").concat(body[prop], "</p>"));
                }
                mailjet = node_mailjet_1["default"].apiConnect(process.env.MJ_APIKEY_PUBLIC || "", process.env.MJ_APIKEY_PRIVATE || "");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
